...
package net.mcreator.projectwinter.entity;
...
import net.mcreator.projectwinter.procedures.ZombieGolem1Procedure;
import net.mcreator.projectwinter.entity.renderer.ZombieGolemRenderer;
import net.mcreator.projectwinter.ProjectwinterModElements;

import com.google.common.collect.ImmutableMap;

@ProjectwinterModElements.ModElement.Tag
public class ZombieGolemEntity extends ProjectwinterModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("zombie_golem").setRegistryName("zombie_golem");
	public ZombieGolemEntity(ProjectwinterModElements instance) {
		super(instance, 29);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ZombieGolemRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737895, -16751104, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("zombie_golem_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return ZombieGolem1Procedure.executeProcedure(ImmutableMap.of("world", world));
				});
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 5;
			setNoAI(false);
			setCustomName(new StringTextComponent("Zombie Golem"));
