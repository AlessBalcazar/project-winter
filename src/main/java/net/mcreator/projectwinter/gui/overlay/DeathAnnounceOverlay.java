...
package net.mcreator.projectwinter.gui.overlay;
...
import net.mcreator.projectwinter.procedures.DeathAnnounceControlProcedure;
...
public class DeathAnnounceOverlay {
	@OnlyIn(Dist.CLIENT)
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			int dummy = (int)ProjectwinterModVariables.MapVariables.get(world).death_img;
