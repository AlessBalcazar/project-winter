package net.mcreator.projectwinter;
...
public class ProjectwinterModVariables {
	public ProjectwinterModVariables(ProjectwinterModElements elements) {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote()) {
			...
			if (mapdata != null)
				ProjectwinterMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "projectwinter_worldvars";
		...
		public void syncData(IWorld world) {
			...
			if (world instanceof World && !world.isRemote())
				ProjectwinterMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(((World) world)::getDimensionKey),
	...
	public static class MapVariables extends WorldSavedData {
		...
		public boolean prog_skeleton_2_flag = false;
		public MapVariables() {
			super(DATA_NAME);
		}
		...
		public void read(CompoundNBT nbt) {
			...
			prog_skeleton_2_flag = nbt.getBoolean("prog_skeleton_2_flag");
		}
		...
		public CompoundNBT write(CompoundNBT nbt) {
			...
			nbt.putBoolean("prog_skeleton_2_flag", prog_skeleton_2_flag);
			return nbt;
		}
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (world instanceof World && !world.isRemote())
				ProjectwinterMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("projectwinter", "player_variables"), new PlayerVariablesProvider());
	}
